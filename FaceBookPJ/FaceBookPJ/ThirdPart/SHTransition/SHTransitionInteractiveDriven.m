//
//  SHTransitionInteractiveDriven.m
//  FaceBookPJ
//
...
@interface SHTransitionInteractiveDriven ()
@property (nonatomic, weak) ASViewController *vc;
/**手势方向*/
...
@implementation SHTransitionInteractiveDriven
...
- (void)addPanGestureForViewController:(ASViewController *)viewController{
    ...
    [viewController.node.view addGestureRecognizer:pan];
}
/**
 *  手势过渡的过程
 */
